...
const Home = () => {
  return (
    <div className=" h-screen bg-cover bg-center bricolage-font pb-6" style={{ backgroundImage: `url(${Bg1})` }}>
        <div className=" pt-8">
            <Navbar />
            <div className="">
                <div className=" flex justify-center pt-16 mx-1 md:mx-0">
                    <p className=' text-4xl md:text-6xl text-white rounded-3xl font-semibold w-fit p-3 px-6' style={{ backgroundColor: '#6200EE'}}>Mint Your NFT</p>
                </div>
                <p className=' text-3xl md:text-6xl text-gray-900 flex justify-center pt-2 font-semibold'>Become an Early Contributor</p>
                <p className=' text-xl text-gray-900 flex justify-center mx-[2%] md:mx-[16%] lg:mx-[22%] pt-6 text-center'>Welcome to the exclusive oppurtunity to mint your NFT and become one of the pioneering contributors to Unify Giving's mission. By minting an NFT, you not only secure proof of your early support but also gain access to special features and benefits as an early adopter</p>
